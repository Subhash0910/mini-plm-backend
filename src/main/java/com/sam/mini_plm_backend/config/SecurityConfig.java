    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        // Changes endpoints - role-based by action
                        .requestMatchers(HttpMethod.GET, "/changes/**").hasAnyRole("ADMIN", "ENGINEER", "VIEWER")
                        .requestMatchers(HttpMethod.POST, "/changes").hasAnyRole("ADMIN", "ENGINEER")                         // Create
                        .requestMatchers(HttpMethod.POST, "/changes/*/submit").hasAnyRole("ADMIN", "ENGINEER")      // Submit for review
                        .requestMatchers(HttpMethod.POST, "/changes/*/approve").hasAnyRole("ADMIN", "ENGINEER")     // Approve/reject
                        .requestMatchers(HttpMethod.POST, "/changes/*/implement").hasAnyRole("ADMIN", "ENGINEER")   // Implement
                        .requestMatchers(HttpMethod.PUT, "/changes/**").hasAnyRole("ADMIN", "ENGINEER")
